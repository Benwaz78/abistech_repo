...
<html class="no-js" lang="zxx">
    <head>
        ...
        <title> ABIS Technologies Limited </title>
                       ...
                       <div class="col-xl-12">
                            <div class="row d-flex justify-content-between align-items-center">
                                <div class="header-info-left">
                                    <ul>     
                                        <li><i class="fas fa-map-marker-alt"></i>15, Seriki Aro Street, Off Ajao Road Ikeja,
Lagos.</li>
                                        <li><i class="fas fa-envelope"></i>Info@abistechnologies.com.ng</li>
                                    </ul>
                                </div>
